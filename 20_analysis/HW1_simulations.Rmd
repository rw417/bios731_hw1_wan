...
**Note:** simulations were taking a long time, so I ran 475 simulations for each scenario with 200 bootstrap samples and 100 samples for the inner loop for bootstrap t intervals. If I had more compute time, I'd take 1,000 bootstrap samples and 500 samples for the inner bootstrap.
